...
static inline int strncmp(const char* str1, const char* str2, size32_t count)
{
...
static inline int strnicmp(const char* str1, const char* str2, size32_t count)
{
    for (size32_t i = 0; i < count; i++) {
        if (str1[i] == 0 && str2[i] == 0) {
            return 0;
...
static inline char* strncpy(char* dest, const char* src, size32_t count)
{
    char* dest_orig;
    do {
        *dest++ = *src;
...
static inline size32_t strnlen(const char* str, size32_t count)
{
...
static inline void* memcpy(void* dest, const void* src, size32_t count)
{
    void* dest_orig = dest;
    if (count >= 16) {
