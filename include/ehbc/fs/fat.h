...
typedef struct {
    ...
    UTF8       last_entry_lfn[FAT_LFN_U8_BUFLEN];
    UTF8       last_entry_sfn[FAT_SFN_BUFLEN];
...
void memberof(FATFileSystem, set_sector_buffer_size)(FATFileSystem* self, uint32_t sect_count);
void memberof(FATFileSystem, set_fat_entry_cache_max_size)(FATFileSystem* self, uint32_t entry_count);
void memberof(FATFileSystem, enable_lfn_support)(FATFileSystem* self, int lfn);
...
int memberof(FATFileSystem, match_name)(void* self, dir_t* path, const UTF8* name, const fileinfo_t** finfo);

int memberof(FATFileSystem, create_directory)(void* self, dir_t* path, const UTF8* name);
int memberof(FATFileSystem, remove_directory)(void* self, dir_t* path, const UTF8* name);
int memberof(FATFileSystem, open_directory)(void* self, dir_t* path, dir_t* dir, const UTF8* name);
...
int memberof(FATFileSystem, create_file)(void* self, dir_t* path, const UTF8* name);
int memberof(FATFileSystem, remove_file)(void* self, dir_t* path, const UTF8* name);
int memberof(FATFileSystem, open_file)(void* self, dir_t* path, file_t* file, const UTF8* name, const char* mode);
...
int memberof(FATFileSystem, test_file)(void* self, dir_t* dir, const UTF8* name);

int memberof(FATFileSystem, move)(void* self, dir_t* origdir, const UTF8* origname, dir_t* tgtdir, const UTF8* tgtname);
int memberof(FATFileSystem, copy)(void* self, dir_t* origdir, const UTF8* origname, dir_t* tgtdir, const UTF8* tgtname);

static const FileSystemTrait impl(FATFileSystem, FileSystemTrait) = {
